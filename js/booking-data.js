/* ============================================================================
   ...
   ВАЖНО про график и длительность услуг.
   Реальные часы барбершопа (Пн-Вс 10:00–22:00) взяты с сайта и совпадают
   у всех мастеров. Обеденный перерыв (lunch) и «загруженность» (load) —
   придуманы для того, чтобы календарь выглядел живым и у разных мастеров
   были разные свободные окна; это НЕ настоящий график. Длительность услуг
   (min) на исходном сайте нигде не указана — проставлена реалистично по
   типу процедуры, чтобы слоты в календаре имели смысл. Поправьте оба блока
   на настоящие данные, когда они появятся.

   Чтобы подключить РЕАЛЬНОЕ расписание (YClients или свой сервер) —
   перепишите одну функцию loadBusy() в booking.js. См. README.md.
   ============================================================================ */
...
window.DOUBLECUTS = {
  ...
  schedule: {
    mikhail:     { days: [0,1,2,3,4,5,6], start: '10:00', end: '22:00', lunch: ['14:00','15:00'], load: 0.72 },
    vadim:       { days: [0,1,2,3,4,5,6], start: '10:00', end: '22:00', lunch: ['15:00','16:00'], load: 0.65 },
    anton:       { days: [0,1,2,3,4,5,6], start: '10:00', end: '22:00', lunch: ['13:00','14:00'], load: 0.55 },
    'pavel-s':   { days: [0,1,2,3,4,5,6], start: '10:00', end: '22:00', lunch: ['13:30','14:30'], load: 0.55 },
    vladislav:   { days: [0,1,2,3,4,5,6], start: '10:00', end: '22:00', lunch: ['14:00','15:00'], load: 0.60 },
    denis:       { days: [0,1,2,3,4,5,6], start: '10:00', end: '22:00', lunch: ['15:00','16:00'], load: 0.40 },
    andrey:      { days: [0,1,2,3,4,5,6], start: '10:00', end: '22:00', lunch: ['15:30','16:30'], load: 0.45 },
    'pavel-b':   { days: [0,1,2,3,4,5,6], start: '10:00', end: '22:00', lunch: ['16:00','17:00'], load: 0.38 }
  },

  /* Личные исключения: отгулы, брони, заведённые вручную. Формат даты — 'ГГГГ-ММ-ДД'.
     Пример: mikhail: { '2026-08-03': { off: true } } */
  scheduleOverrides: {},
